        ...
        <div class="content mt-3">
            <div class="col-sm-12">
                <div class="alert  alert-success alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill badge-success">Sucesso</span> Você foi logado com sucesso!
                                        ...
                                        ?>
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                    ...
                                                    <a a href="apaga_cliente.php?id=<?php echo $dados['id_cliente']; ?>" class="btn btn-danger" >Apagar</a>                                                    
                                                </div>
                                            </td>
                                        <?php
                                            echo "</tr>";
...
<script>
    function myFunction() {
        alert("Você realmente deseja apagar este cliente?");
    }
</script>
